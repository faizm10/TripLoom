...
const trips: Trip[] = [
  {
    ...
    budgetTotal: 1820,
    perPerson: 607,
    flightSummary: "Round-trip, 1 stop, 10h 45m total",
    activities: [
      "Added museum visit to Day 2",
      "Price dropped on outbound flight by $37",
      "Sam requested downtown hotel options",
    ],
  },
  {
    id: "tokyo-fall",
